...
set_default_params;
% W = insertWeightToMatrix(W, params, "th" , "c" ,0);
x0 = gen_random_int_cond(Wc2c,Nch,8,0);
load mdata.mat
m_desired= mdata;
...
for init_ind = 1:8
    ...
    Y((init_ind-1)*int32(dur/dt) + 1: init_ind*int32(dur/dt),:) = ...
        [zeros(2,prep_step + phasic_step)  mdata.m{init_ind}(:,1:10000-phasic_step) zeros(2,10000-prep_step)]';
